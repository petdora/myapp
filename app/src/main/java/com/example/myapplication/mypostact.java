...
//            @Override
//            public void onClick(View view) {
//                Intent change = new Intent(mypostact.this, active.class);
...
//            @Override
//            public void onClick(View view) {
//                Intent change = new Intent(mypostact.this, myattendact.class);
//                startActivity(change);
//            }
//
//        });
            ...
            Btn[k].setOnClickListener(new Button.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for(int j = 0; j< HomeFragment.count; j++){
                        if(HomeFragment.act_id[j]==act_id[i]){
                            Intent change = new Intent(mypostact.this, postinthat.class);
                            startActivity(change);
                            HomeFragment.click = j;

                        }
                    }
                    HomeFragment.hasjoin=false;
                    HomeFragment.joinpeople=0;
                    for(int att=0;att<=att_count;att++){
                        if(att_uid[att]== login.loginid && act_id[i]==att_id[att]){
                            HomeFragment.hasjoin=true;
                            HomeFragment.docu_id=attend_documentid[att];
